...
/******/ 	return __webpack_require__(__webpack_require__.s = "./wp-content/themes/_ws/src/js/front/calc.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./wp-content/themes/_ws/src/js/front/calc.js":
/*!****************************************************!*\
  !*** ./wp-content/themes/_ws/src/js/front/calc.js ***!
  \****************************************************/
/*! no exports provided */
...
var calc = new vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
  ...
  created: function created() {
    ...
    hiddens.forEach(function (hidden) {
      _this.data[hidden.name] = hidden.value;
    });
    selects.forEach(function (select) {
      _this.data[select.name] = select.value;
    });
    fieldsets.forEach(function (fieldset) {
      ...
      _this.data[fieldset.id] = value;
    });
  },
  methods: {
    changeStep: function changeStep(s) {
      var _this2 = this;
      ...
      var fields = this.$refs[this.step].querySelectorAll('input, textarea, select');
      fields.forEach(function (field) {
        ...
        if (field.type === 'radio' || field.type === 'checkbox') {
          if (!_this2.data[field.name] || _this2.data[field.name].length === 0) {
...
/******/ });
//# sourceMappingURL=calc-js.min.js.map?ver=1de14345